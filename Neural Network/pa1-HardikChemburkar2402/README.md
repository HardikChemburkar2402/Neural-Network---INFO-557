[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/P_e7cxLn)
# Objectives
...
```
https://github.com/ml4ai-2025-spring-nn/pa1-<your-username>
```
...
```
https://github.com/ml4ai-2025-spring-nn/hw1-strings-to-vectors-<your-username>.git
```
You are now ready to begin working on the assignment.

NOTE: You should do all your work in the default branch, `main`.
